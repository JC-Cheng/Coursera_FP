...
$c_Lcalculator_Polynomial$.prototype.calculator$Polynomial$$solSet$1__D__D__D__D__sci_List = (function(A, B, C, D) {
  if ((D < 0)) {
    return $m_sci_Nil$()
  } else if ((D > 0)) {
    var sqrtD = $uD($g.Math.pow(D, 0.5));
    var x$2 = (((-B) + sqrtD) / (2 * A));
    var x$1 = (((-B) - sqrtD) / (2 * A));
    var this$3 = $m_sci_Nil$();
    var this$4 = new $c_sci_$colon$colon().init___O__sci_List(x$1, this$3);
    return new $c_sci_$colon$colon().init___O__sci_List(x$2, this$4)
  } else {
    var x$3 = ((-B) / (2 * A));
    var this$5 = $m_sci_Nil$();
    return new $c_sci_$colon$colon().init___O__sci_List(x$3, this$5)
  }
});
$c_Lcalculator_Polynomial$.prototype.computeSolutions__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal = (function(a, b, c, delta) {
  ...
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(a$2, b$2, c$2, delta$1) {
    return (function() {
      var this$1 = $m_Lcalculator_Polynomial$().calculator$Polynomial$$solSet$1__D__D__D__D__sci_List($uD(a$2.apply__O()), $uD(b$2.apply__O()), $uD(c$2.apply__O()), $uD(delta$1.apply__O()));
...
$c_Lcalculator_TweetLength$.prototype.colorForRemainingCharsCount__Lcalculator_Signal__Lcalculator_Signal = (function(remainingCharsCount) {
  ...
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(remainingCharsCount$1) {
    return (function() {
      return $m_Lcalculator_TweetLength$().calculator$TweetLength$$mapLength$1__I__T($uI(remainingCharsCount$1.apply__O()))
    })
  })(remainingCharsCount));
  return new $c_Lcalculator_Signal().init___F0(expr)
});
$c_Lcalculator_TweetLength$.prototype.calculator$TweetLength$$mapLength$1__I__T = (function(l) {
  return ((l >= 15) ? "green" : ((l >= 0) ? "orange" : "red"))
});
